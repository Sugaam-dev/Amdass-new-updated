...
const PrivacyPolicy = () => {
  return (
    <main className="privacy-policy-container">
      <h2 className="privacy-title">Privacy Policy For Amddas Foods</h2>
      <p className="privacy-last-updated">Last updated: September 17, 2024</p>
      ...
      <section className="privacy-section">
        <h3 className="privacy-section-title">Interpretation and Definitions</h3>

        <h4 className="privacy-subsection-title">Interpretation</h4>
        <p className="privacy-paragraph">
          The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>

        <h4 className="privacy-subsection-title">Definitions</h4>
        ...
        <ul className="privacy-list">
          ...
          <li className="privacy-list-item">
            <strong>Application</strong> refers to amddas food, the software program provided by the Company.
          </li>
          <li className="privacy-list-item">
            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Amddas foods, Kadugodi, Bangalore, Karnataka 560067.
          </li>
          <li className="privacy-list-item">
      ...
      <section className="privacy-section">
        <h3 className="privacy-section-title">Collecting and Using Your Personal Data</h3>

        <h4 className="privacy-subsection-title">Types of Data Collected</h4>

        <h5 className="privacy-subsubsection-title">Personal Data</h5>
        <p className="privacy-paragraph">
        ...
        <ul className="privacy-list">
          ...
          <li className="privacy-list-item">Usage Data</li>
        </ul>

        <h5 className="privacy-subsubsection-title">Usage Data</h5>
        <p className="privacy-paragraph">
      ...
      <section className="privacy-section">
        <h3 className="privacy-section-title">Use of Your Personal Data</h3>
        <p className="privacy-paragraph">
        ...
        <h4 className="privacy-subsection-title">Sharing Your Personal Information</h4>
        <p className="privacy-paragraph">
      ...
      <section className="privacy-section">
        <h3 className="privacy-section-title">Retention of Your Personal Data</h3>
        <p className="privacy-paragraph">
      ...
      <section className="privacy-section">
        <h3 className="privacy-section-title">Transfer of Your Personal Data</h3>
        <p className="privacy-paragraph">
      ...
      <section className="privacy-section">
        <h3 className="privacy-section-title">Delete Your Personal Data</h3>
        <p className="privacy-paragraph">
      ...
      <section className="privacy-section">
        <h3 className="privacy-section-title">Disclosure of Your Personal Data</h3>

        <h4 className="privacy-subsection-title">Business Transactions</h4>
        <p className="privacy-paragraph">
          If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
        </p>

        <h4 className="privacy-subsection-title">Law enforcement</h4>
        <p className="privacy-paragraph">
          Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
        </p>

        <h4 className="privacy-subsection-title">Other legal requirements</h4>
        <p className="privacy-paragraph">
      ...
      <section className="privacy-section">
        <h3 className="privacy-section-title">Security of Your Personal Data</h3>
        <p className="privacy-paragraph">
      ...
      <section className="privacy-section">
        <h3 className="privacy-section-title">Changes to this Privacy Policy</h3>
        <p className="privacy-paragraph">
      ...
      <section className="privacy-section">
        ...
        <ul className="privacy-list">
          <li className="privacy-list-item">
            By email: <a href="mailto:info@amddas.net" className="privacy-link">info@amddas.net</a>
          </li>
        </ul>
        <p className="privacy-paragraph">
